 ...
 */
+ (instancetype)poseDetectorWithOptions:(MLKPoseDetectorOptions *)options
 ...
 */
- (void)processImage:(MLKVisionImage *)image completion:(MLKPoseDetectionCallback)completion
 ...
 */
- (nullable NSArray<MLKPose *> *)resultsInImage:(MLKVisionImage *)image error:(NSError **)error;
